...
(()=>{
    ...
    const getScreenBounds = function() {
        ...
        if (height > width && height > 780) {
            if (width > 780 && height > 1000) imageGrid = 13;
            else if (width > 1000 && height > 1000) imageGrid = 17;
            else if (height < 1000) imageGrid = 9;
            else if (height < 900) imageGrid = 7;
            else imageGrid = 7;
        } else {
            if (width > 750) imageGrid = 9;
            else if (width > 500 && !(width > 750)) imageGrid = 7;
            else if (width > 350) imageGrid = 5;
            else if (width > 250) imageGrid = 3;
            else imageGrid = 7;
        }
        return {
            height: height,
    ...
    const appendImg = async function() {
        ...
        for(let i = 1; i < imageGrid; i++){
            ...
            if (!(obj.width + obj.height > 500)) obj = await getImg();
            else {
                console.log(obj.url);
                img.src = obj.url;
                img.id = `image${i}`;
                console.log(`A/An ${obj.name} cat. ${obj.description}`);
